...
const networkFirstFiles = ['./index.html', './style.css', './script.js', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  const isNetworkFirst = networkFirstFiles.some(
    (file) => pathname.endsWith(file) || pathname === '/' || pathname === '/index.html'
  );
